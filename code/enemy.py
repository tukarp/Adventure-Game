...
class Enemy(Entity):
    ...
    # get the direction and distance to player
    ...
    # update enemy statuses depending on distance from player
    ...
    # update enemy depending on the player interaction
